                ...
                <div role="none">
                    ...
                    @role('admin')
                        <a href="{{ route('users.index') }}"
                            class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">User</a>
                    @endrole
                    <div class="my-2 border-b border-gray-200"></div>
                    @role('admin')
                        <a href="{{ route('articles.index') }}"
                            class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">Article</a>
                    @endrole
                    <a href="{{ route('diagnosis.index') }}"
                        class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">Diagnosis</a>
                    <a href="{{ route('assessments.index') }}"
                        class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">Therapy</a>
                    <div class="my-2 border-b border-gray-200"></div>
                    <a href="{{ route('profile.edit') }}"
                        class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">Profile</a>
                    <a href="{{ route('settings.edit') }}"
                        class="block p-2 text-sm rounded-md text-gray-700 hover:bg-gray-100" role="menuitem">Settings</a>
                    <div class="my-2 border-b border-gray-200"></div>
